...
export default function Sidebar(){
 const p=usePathname(),router=useRouter();const[open,setOpen]=useState(false);const[name,setName]=useState('Kost Harmoni');const[logo,setLogo]=useState('');
