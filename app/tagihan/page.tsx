...
export default function Tagihan(){
 ...
 const pay=()=>{
  ...
  setP(n);saveData('payments',n);saveData('transactions',transactions);setShow(false);setMsg('Pelunasan berhasil. Transaksi pendapatan dan nomor kwitansi sudah dicatat. Membuka kwitansi...');
  setTimeout(()=>{location.href='/kwitansi?id='+encodeURIComponent(current.id)},250);
 };
